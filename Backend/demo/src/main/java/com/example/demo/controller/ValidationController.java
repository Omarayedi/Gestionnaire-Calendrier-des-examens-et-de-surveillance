...
public class ValidationController {
    ...
    public List<Validation> getValidationsByExamId(@PathVariable Integer examId) {
        return validationService.getValidationsByExamId(examId);
    }

    @GetMapping("/user/{userId}")
    public List<Validation> getValidationsByUserId(@PathVariable Integer userId) {
    ...
    @DeleteMapping("/{id}")
    public void deleteValidation(@PathVariable Integer id) {
